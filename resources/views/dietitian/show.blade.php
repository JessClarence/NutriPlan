...
<body>
    <div class="wrapper">
        <div class="sidebar">
            ...
            <a href="show" class="active">Dietitian</a>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $dietitian->id }}</td>
                                <td>{{ $dietitian->first_name }} {{ $dietitian->last_name }}</td>
                                <td>{{ $dietitian->condition_type }}</td>
                                <td>{{ ucfirst($dietitian->gender) }}</td>
                                <td>{{ $dietitian->date_of_admission }}</td>
                                <td>
