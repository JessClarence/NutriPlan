...
<body>
    <div class="wrapper">
        <div class="sidebar">
            ...
            <a href="create" class="active"> Nurse Assessment</a>
            <h5>Others</h5>
            <a href="show">Patient Records</a>
            <a href="#">Settings</a>
            <a href="#">Logout</a>
        </div>
        <!-- Main Content -->
            ...
            <div class="card">
                <div class="card-body"> 
                    ...
                    <form action="{{ route('nurse.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label name="condition_type" class="form-label">Condition Type</label>
                                <input type="text" name="condition_type" class="form-control" id="condition_type" placeholder="Condition Type">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="bmi" class="form-control" id="bmi" placeholder="BMI" disabled>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label name="daily_activity" class="form-label">Daily Activity</label>
                                <select name="daily_activity" class="form-select" id="daily_activity">
